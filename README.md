...
宝可梦冠军-对战助手是一个专为 Pokemon Champion（宝可梦冠军）竞技设计的辅助决策系统。帮助选手在紧张对战中快速追踪双方队伍状态、计算行动顺位、分析属性克制关系，并实时监控对战环境因素。
...
---
## 联系方式 : 如果您有任何疑问，请提出问题或通过1049355523@qq.com联系我们。
...
├── pokemon_battle_assistant.html       # 前端主文件 (~2350行)
...
├── 宝可梦对战助手_v11.html_宝可梦对战助手功能列表 (1).md  # 本文档
├── data/
...
**实现位置：** `TYPES` 常量、防守弱点统计面板、属性分布面板

- 所有属性图标从 Iconify `mdi:` 系列替换为 PokeAPI type 精灵图
- URL 格式：`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-ix/scarlet-violet/{1-18}.png`
- 朱/紫第九世代风格，18种属性各有独立图标
- 防守弱点面板：图标尺寸 117×29px
- 属性分布面板：保留彩色小圆点（不使用图片）
